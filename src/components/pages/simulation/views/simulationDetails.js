...
class SimulationDetails extends Component {
  ...
  render() {
    ...
    const { simulation, metrics, hubMetricsPollingError, simulationPollingError, preprovisionedIoTHubInUse, enabled, devicesCreationComplete, devicesDeletionInProgress, devicesDeletionCompleted } = this.state;
            ...
            <div className="stack-container">
              {
                id && <div className="info-container">
                  ...
                  {
                    !devicesDeletionCompleted && !this.state.enabled && stopTime != null &&
                      <div className="info-section">
